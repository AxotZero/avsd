...
from .rnn import GRU
from .text_decoder import TextEncoder, TextUniDecoder, TextCrossDecoder
...
class AVSDTan(nn.Module):
    def __init__(self, cfg, train_dataset):
        ...
        # encode text
        self.text_uni_decoder = TextUniDecoder(cfg, vocab_size, cls_idx)
        ...
        # 
        self.text_cross_decoder = TextCrossDecoder(cfg)
